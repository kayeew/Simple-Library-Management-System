...
<div id="main-content">
	<!-- Breadcrumb -->
	<p><a href="home.php">Home</a> > <a href="subject.php">Subject Table</a> > Edit Mode</p> 
	<h2 id="padding">Subject Table</h2>
	...
	<?php
		$qry = "SELECT * FROM subject Order by Subject_ID ASC";
		...
		if($i%2==0) // styling purpose for even/odd rows
			...
			$classname="oddRow";
		?>
		<form action="includes/subject-process.php" method="post">
		<tr class="<?php if(isset($classname)) echo $classname;?>">
			...
			<td>
			<input type="text" name="subdesc" value="<?php echo $row['Subject_Desc']; ?>">
			</td>
